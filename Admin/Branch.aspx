<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="false"
    CodeFile="Branch.aspx.vb" Inherits="_Default" Trace="false" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table id="tblLeave" class="rounded-q4" width="100%" >
        <tr>
            <td style="height:30px;" colspan="2"><strong>Branch </strong>
            </td>
                </tr>
        <tr>
            <td class="style1">
                Branch Name :</td>
            <td width="70%">
                <asp:TextBox ID="txtBranchName" runat="server" onmouseout="tip.hide()" 
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtBranchName" ErrorMessage="RequiredFieldValidator" 
                    ForeColor="#FF3300">Enter the Branch Name</asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="newbutton" 
                    Width="50px" />
                &nbsp;
                <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="newbutton"  CausesValidation="false" 
                    Width="50px" />
                </td>
        </tr>
    </table>
